...
pub use manifest::{
    ...
    Manifest, ManifestDependency, ManifestDependencySpec, ManifestDocument, ManifestError,
    ManifestSource, ManifestTarget, RegistryProvenancePolicy, RegistrySpec, RepositorySpec,
    compose_resolution_request, compose_resolution_request_with_locked, discover_manifest,
    load_manifest, parse_manifest, read_manifest,
};
