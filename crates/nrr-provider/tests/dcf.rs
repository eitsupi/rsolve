use nrr_provider::cran::{DcfDocument, DcfError};
...
fn reads_synthetic_packages_and_preserves_record_values() {
    ...
    let expected = [
        ("nrrfixture.core", "0.1.0", "2026-06-24 19:14:59 UTC"),
        ("nrrfixture.folded", "0.2.0", "2026-06-25 19:14:59 UTC"),
        ("nrrfixture.rare", "1.0.0", "2026-06-26 19:14:59 UTC"),
        ("nrrfixture.plain", "3.0.0", "2026-06-27 19:14:59 UTC"),
    ];
